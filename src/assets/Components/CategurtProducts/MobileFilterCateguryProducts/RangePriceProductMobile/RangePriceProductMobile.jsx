...
export default function RangePriceProductMobile() {
  ...
  return (
    <div className="bg-white p-4 flex font-Dana items-center flex-col rounded-md w-full border-1 border-slate-200 border-solid text-sm">
      <div
